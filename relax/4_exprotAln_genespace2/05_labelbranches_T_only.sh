...
arrOutgroupSpp='Gobiopsis_macrostoma,Glossogobius_giuris,Neogobius_melanostomus,Rhinogobius_formosanus,Rhinogobius_similis,Tridentiger_bifasciatus,Tridentiger_barbatus,Tridentiger_radiatus,Taenioides_sp,Boleophthalmus_pectinirostris,Periophthalmus_modestus,Siphamia_tubifer,Odontamblyopus_rebecca,Oxyeleotris_marmorata,Periophthalmus_magnuspinnatus';
arrUnusedClades=''; #c('Aplocheilidae', 'root'); #mark as unused clades "only for hyphy relax"
arrMarkUnusedCladeChildren=''; #c(T , F);

#######################################################################
arrForegroundClades='Clade4'; #mark as foreground
arrMarkForegroundChildren='T';

sTaxonRequirements="min_taxon_requirements.txt";

nMarkStyle='relax'; #either "codeml" or "relax"
sOutDIR="Relax_T_only";
