...
raw_counts <- tibble::tribble(
  ...
  "test",     "FSR",         "<25%",       "Tba",    261, 32314,
  "test",     "FSR",         "<25%",       "Tra",    99, 7912,
  "test",     "FSR",         "25%-50%",    "Tba",     83, 24510,
  "test",     "FSR",         "25%-50%",    "Tra",     40, 4037,
  "test",     "FSR",         "50%-<100%",  "Tba",    337, 138058,
  "test",     "FSR",         "50%-<100%",  "Tra",     25, 28271,
  "test",     "FSR",         "100%",       "Tba",   2118, 1072028,
  "test",     "FSR",         "100%",       "Tra",   1048, 618222,

  "control",  "noFSR",       "<25%",       "Tba",    215, 24938,
  "control",  "noFSR",       "<25%",       "Tra",    128, 13137,
  "control",  "noFSR",       "25%-50%",    "Tba",     83, 18041,
  "control",  "noFSR",       "25%-50%",    "Tra",     49, 8649,
  "control",  "noFSR",       "50%-<100%",  "Tba",    437, 105874,
  "control",  "noFSR",       "50%-<100%",  "Tra",     94, 31139,
  "control",  "noFSR",       "100%",       "Tba",   1456, 841838,
  "control",  "noFSR",       "100%",       "Tra",    702, 465990
)
