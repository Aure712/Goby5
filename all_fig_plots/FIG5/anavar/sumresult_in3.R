...
# 设置要分析的文件夹
arrSrcDirs <- c("../tra_in", "../tba_in")  # 两个文件夹
arrPlotNames <- c("Tra_FSR", "Tba_FSR")    # 对应的图表显示名称（可在此处自由修改）
...
# 分析两个文件夹
results_tra <- analyzeFolder(arrSrcDirs[1], arrRunTypes[1], arrParamCounts[1], "tra_in")
results_tba <- analyzeFolder(arrSrcDirs[2], arrRunTypes[2], arrParamCounts[2], "tba_in")
